...
| Console: Admin and Sources screens; the planned Specs entry | Five screens: Imposters, Routes, Scenarios, Requests, Cluster — the Scenarios screen stays, because the flow-state tier it faces stays (§3.1) | RFC-006 §4 amended | #553 |
