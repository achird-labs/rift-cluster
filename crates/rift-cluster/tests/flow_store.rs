...
/// unreachable peer. A full multi-node HTTP round trip is not the practical
/// place to inject "peer unreachable" — this unit-tests the fan-out itself, the same layer
